...
Item {
    ...
    property var metadata: {
        ...
        'ps1': { color: '#365f8d', vendor: 'Sony', year: '1994-2006' },
        'recents': { color: '#906226', vendor: 'past 30 days' },
        'ss': { color: '#5b92ff', vendor: 'Sega', year: '1994-2000' },
        ...
        'wii': { color: '#ee6501', vendor: 'Nintendo', year: '2006-2017' },
