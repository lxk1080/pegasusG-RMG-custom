...
FocusScope {
    ...
    property string sortKey: 'favorite';
    ...
    Component.onCompleted: {
        ...
        sortKey = api.memory.get('favorite') ?? 'favorite';
    ...
    property var allCollections: {
        ...
        collections.unshift({'name': '收藏游戏', 'shortName': 'favorites', 'games': allFavorites});
        collections.unshift({'name': '最近游戏', 'shortName': 'recents', 'games': filterLastPlayed});
        collections.unshift({'name': '全部游戏', 'shortName': 'allgames', 'games': api.allGames});
    ...
    SortFilterProxyModel {
        ...
        sorters: [
            RoleSorter { roleName: 'favorite'; sortOrder: Qt.DescendingOrder; enabled: favoritesOnTop && currentCollection.shortName != 'recents'; },
